...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product">
      <div>
        <img class="product-image" src="${image}" alt="Card image cap">
      </div>
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-lg-6">
          <p class="card-text"><small class="text-muted">Total Rating:${product.rating.count}</small></p>
          </div>
          <div class="col-lg-6">
          <p class="card-text"><small class="text-muted">Avg Rating:${product.rating.rate}</small></p>
          </div>
...
const getInputValue = (id) => {
  ...
  const converted = parseFloat(element);//parsing the input value into floating point number
  return converted;
};
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText = total.toFixed(2);//fix the floating number in two decimal point
};

// set innerText function
const setInnerText = (id, value) => {
  document.getElementById(id).innerText = parseFloat(value).toFixed(2);//fix the floating number in two decimal point
};
...
const updateTaxAndCharge = () => {
  ...
  if (priceConverted > 200) {
    ...
    console.log(priceConverted * 0.2);
  }
...
const updateTotal = () => {
  ...
  document.getElementById("total").innerText = parseFloat(grandTotal).toFixed(2);//showing the value for two decimal points
};
